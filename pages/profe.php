...
<html lang="es">
  ...
  <header>
      ...
      <div>
        ...
        <nav id="nav">
          <h1 class="text-white">ASISTENCIAS</h1>
      ...
      <div class="form">
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
          <div class="searchPartner">
            ...
            <div>
              <input href="profe.php" type="submit" class="nav-button2" value="MOSTRAR TODOS">
            </div>
          </div>
        </form>
            ...
            <table class="table">
              ...
              ?>
                  <tr>
                    ...
                    <td data-label="ACCIONES"><?php echo '<a class="nav-button2 btn-asistencia" href="asistencia.php?numero='.$filas["numero"].'">ASISTENCIA</a>';?> 
                  </tr>
              <?php
                }
