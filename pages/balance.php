...
<html lang="es">
  ...
  <body>
    ...
    <div class="btn-balance">
      <a href="facturacion.php" type="submit" class="nav-button2" value="facturacion">FACTURACION EMITIDA</a></br>
      <a href="ingresos.php" type="submit" class="nav-button2" value="ingresos">INGRESOS MENSUALES</a>
